...
namespace Lab7.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Шиян Илья Иванович  ","2","1","2","2","0","2","2",false),
                new Note("Муромец Илья Иванович","2","1","1","1","0","1","2",false),
                new Note("Бумажков Владислав Антонович","2","0","2","0","1","1","0",false),
            };
        }
